...
- **의존성 주입 Factory 설계**: `InventoryViewModel.companion object` 내부의 `provideFactory()`를 통해 ViewModel에 Repository 의존성을 주입합니다. 별도 Factory 클래스 없이 ViewModel 내부로 응집시켜 관련 코드를 한곳에서 관리합니다.
