...
- 제품 요약과 신규 등록 화면에서 이미지를 첫 번째 정보로 중앙 배치
- 제품 이미지 영역의 + 버튼에서 카메라 촬영 또는 Android Photo Picker를 선택해 이미지를 추가·변경
...
- 이미지 유무와 관계없이 제품 이미지 영역의 + 버튼에서 촬영 또는 파일 선택으로 이미지를 추가·변경할 수 있다.
